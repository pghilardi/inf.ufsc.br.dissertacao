...
\section{Perfil UML proposto por Evermann \cite{Evermann:2007:MSP:1229375.1229379}}
...
\section{Reusable Aspect Models (RAM) proposto por Kienzle \cite{Kienzle:2009:AMM:1509239.1509252}}
...
\section{Modelagem de aspectos com diagrama de atividades proposta por Cui \cite{Cui:2009:MIA:1529282.1529377}}
...
\section{Modelagem de aspectos com casos de uso proposta por Jacobson \cite{Jacobson:2004:ASD:1062430}}
...
Outra limitação é a forma de extensão à UML, com a definição de um meta-modelo, que não pode ser utilizado em qualquer ferramenta CASE. Este
meta-modelo tem construções específicas, como fatias de caso de uso, que não são suportadas por ferramentas CASE que obedecem os padrões da segunda
versão da UML.

\section{Motorola WEAVR proposto por Cottenier \cite{Cottenier06themotorola}}
...
\section{Modelagem de aspectos proposta por Klein \cite{Klein:2006:SWS:1119655.1119662}}
...
\section{Theme/UML proposto por Clarke \cite{clarke:04}}
...
\section{Modelagem de aspectos com diretivas de composição proposta por France \cite{france:06}}
...
\cite{ocl:12} do método \textit{writeLine()} no modelo primário.
...
A remoção da especificação OCL e da associação entre classes podem ser visualizadas na figura \ref{fig:clarke_2}, que mostra os modelos após a
aplicação das diretivas de composição. Após a aplicação das diretivas, a composição de modelos pode ser realizada sem disparar conflitos entre
...
\section{Modelagem de aspectos proposta por Stein \cite{stein:02}}
...
Existem algumas abordagens para modelagem de sistemas orientados a aspectos. É importante identificar alguns pontos de variação entre estas
abordagens. Este artigo propõe uma comparação entre diferentes abordagens considerando alguns critérios de comparação. Alguns critérios são baseados 
em outros trabalhos disponíveis na literatura, como o trabalho de Wimmer \cite{wimmer:2011:SUA:1978802.1978807}. Utilizam-se os seguintes critérios
propostos por Wimmer \cite{wimmer:2011:SUA:1978802.1978807}:
